        ...
        <div class="flex min-w-0 flex-1 flex-col">
            ...
            <header class="sticky top-0 z-30 border-b border-slate-200 bg-white/90 backdrop-blur/90">
                <div class="flex h-16 items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex min-w-0 items-center gap-3">
                        <a href="{{ route('profile.show') }}" class="hidden min-w-0 text-right sm:block hover:opacity-80 transition">
                        ...
                        <a href="{{ route('profile.show') }}" class="hover:opacity-80 transition">
                            @if(Auth::user()->avatar)
