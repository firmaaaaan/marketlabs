...
<div class="flex flex-wrap items-center justify-between gap-4">
    <div>
        ...
        <p class="mt-1 text-sm text-slate-600">Seluruh pemberitahuan untuk Anda: penugasan riset, pengujian, dan pemeriksaan kesehatan.</p>
    </div>
...
<div class="mt-8 space-y-3">
    @forelse ($notifications as $n)
        @php
            $url = $n->data['url'] ?? route('laboran.index');
    ...
    @empty
        <div class="rounded-2xl border border-dashed border-slate-300 bg-white p-14 text-center">
            ...
            <p class="mt-1 text-sm text-slate-500">Notifikasi penugasan riset, pengujian, dan pemeriksaan akan muncul di sini.</p>
        </div>
    @endforelse
</div>
