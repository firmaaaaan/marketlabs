        ...
        <div class="mt-5 grid gap-5 sm:grid-cols-2">
            ...
            <div>
                ...
                <select id="type" name="type" required
                    ...
                    <option value="kesehatan" {{ old('type', 'kesehatan') === 'kesehatan' ? 'selected' : '' }}>Kesehatan</option>
                    <option value="non-kesehatan" {{ old('type') === 'non-kesehatan' ? 'selected' : '' }}>Non-Kesehatan</option>
                </select>
                @error('type')
