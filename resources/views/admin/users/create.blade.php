...
@section('title', 'Tambah User - MarketLabs')
...
<h1 class="mt-3 text-2xl font-extrabold tracking-tight text-slate-900">Tambah User</h1>
<p class="mt-1 text-sm text-slate-600">Buat akun baru dan tetapkan role (mis. laboran untuk penugasan permohonan riset).</p>
