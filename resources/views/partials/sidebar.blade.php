    ...
    <div class="flex items-center justify-between px-6 py-5">
        ...
        @forelse ($sidebarMenuItems as $item)
            @php
                ...
                $group = match(true) {
                    str_contains($item->route_name ?? '', 'dashboard') || str_contains($item->route_name ?? '', 'notif') || str_contains($item->route_name ?? '', 'kalender') || str_contains($item->route_name ?? '', 'analytics') => 'Umum',
