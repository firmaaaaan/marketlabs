    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/30 to-stone-50 py-12 lg:py-16">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="reveal flex flex-wrap items-end justify-between gap-4">
                ...
                <a href="{{ route('tools.index') }}"
               class="group inline-flex items-center gap-1.5 rounded-lg border border-stone-200 bg-white px-4 py-2 text-sm font-medium text-slate-700">
                    Lihat semua
                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                <div class="group flex flex-col overflow-hidden rounded-2xl border border-stone-200 bg-white transition hover:border-emerald-300 hover:shadow-md">
                    <a href="{{ route('tools.show', $tool) }}" class="block overflow-hidden">
                        <div class="relative flex h-48 items-center justify-center bg-slate-50">
                            ...
                            @endif
                            <span class="absolute top-3 left-3 rounded-lg px-2.5 py-1 text-[11px] font-semibold
                            ...
                            <span class="absolute top-3 right-3 rounded-lg px-2.5 py-1 text-[11px] font-semibold
                                {{ $tool->available_stock <= 3 ? 'bg-amber-50 text-amber-700' : 'bg-emerald-50 text-emerald-700' }}">
                ...
                <div class="group flex flex-col overflow-hidden rounded-2xl border border-stone-200 bg-white transition hover:border-emerald-300 hover:shadow-md">
                    <a href="{{ route('sample-tests.parameter', $parameter) }}" class="block overflow-hidden">
                        <div class="relative flex h-48 items-center justify-center bg-slate-50">
                            ...
                            @endif
                            <span class="absolute top-3 left-3 rounded-lg bg-emerald-50 px-2.5 py-1 text-[11px] font-semibold text-emerald-700">
                                Tersedia
                            </span>
                        </div>
                    </a>
