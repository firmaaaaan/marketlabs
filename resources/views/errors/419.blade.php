...
<head>
    ...
    <title>Sesi Berakhir - MarketLabs</title>
    @vite(['resources/css/app.css'])
</head>
<body class="bg-slate-50 font-sans text-slate-800 antialiased">
    <div class="flex min-h-screen flex-col items-center justify-center px-4">
        <div class="text-center">
            <p class="text-8xl font-extrabold text-sky-500">419</p>
            <h1 class="mt-4 text-2xl font-bold text-slate-900">Sesi Berakhir</h1>
            <p class="mt-2 text-slate-600">Sesi Anda telah berakhir. Silakan muat ulang halaman dan coba lagi.</p>
