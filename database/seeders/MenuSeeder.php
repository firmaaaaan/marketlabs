...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $sidebarItems = [
            ...
            ['label' => 'Kalender', 'route_name' => 'admin.calendar.index', 'sort_order' => 2, 'is_active' => true],
            ['label' => 'Kelola Alat', 'route_name' => 'admin.tools.index', 'sort_order' => 3, 'is_active' => true],
            ['label' => 'Kelola Kategori', 'route_name' => 'admin.categories.index', 'sort_order' => 4, 'is_active' => true],
            ['label' => 'Satuan & Parameter', 'route_name' => 'admin.sample-units.index', 'sort_order' => 5, 'is_active' => true],
            ['label' => 'Bentuk & Jenis Sampel', 'route_name' => 'admin.sample-attributes.index', 'sort_order' => 6, 'is_active' => true],
            ['label' => 'Kelola Laboratorium', 'route_name' => 'admin.laboratoriums.index', 'sort_order' => 7, 'is_active' => true],
            ['label' => 'Kelola User', 'route_name' => 'admin.users.index', 'sort_order' => 8, 'is_active' => true, 'min_role' => 'superadmin'],
            ['label' => 'Kelola Peminjaman', 'route_name' => 'admin.borrowings.index', 'sort_order' => 9, 'is_active' => true],
            ['label' => 'Permohonan Riset', 'route_name' => 'admin.research.index', 'sort_order' => 10, 'is_active' => true],
            ['label' => 'Pengujian Sampel', 'route_name' => 'admin.sample-tests.index', 'sort_order' => 11, 'is_active' => true],
            ['label' => 'Pemeriksaan Kesehatan', 'route_name' => 'admin.health-checkups.index', 'sort_order' => 12, 'is_active' => true],
            ['label' => 'Tarif Pemeriksaan', 'route_name' => 'admin.health-checkup-types.index', 'sort_order' => 13, 'is_active' => true],
            ['label' => 'Jadwal Layanan', 'route_name' => 'admin.schedule.index', 'sort_order' => 14, 'is_active' => true],
